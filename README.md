...
- **QB Preseason Activation Phase 1 (2026-08-05):** all 32 QB situations researched from current sources. 28 settled (0/0, High), 3 uncertain (ATL/CLE/MIN, blank/Low), 1 proposed deviation pending approval (LV: Cousins over priced-in Mendoza). No non-zero QB value entered; delta 0 everywhere. Deliverables in `audit/qb_*`. Working copy is **not promoted**; authoritative v1.1 untouched.
